...
(* OASIS_START *)
(* DO NOT EDIT (digest: b6d2c2d987d81c9cfe01439defb48758) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["OxStart"; "OxPlatform"];
                      lib_pack = false;
                      lib_internal_modules = ["OxShared"];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Ox Platform Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some ")\246\133\161g\0113[K*p\139\014\230\012\\";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
